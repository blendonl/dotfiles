  ...
  keys = {
    {
      ...
      function()
        ...
        vim.cmd("Neotree action=focus reveal dir=" .. find_git_root() .. " position=bottom toggle=true")
      end,
...

    {
      "<leader>fe",
      function()
        vim.cmd("Neotree action=focus reveal position=bottom toggle=true")
      end,
    ...
    config = function()
      require("neo-tree").setup({
        config = {
          ...
          popup_border_style = "rounded", -- "double", "rounded", "single", "solid", (or "" to use 'winborder' on Neovim v0.11+)
